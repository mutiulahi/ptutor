	...
	<div class="sign-in-form">
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="register">
				...
				<!-- Form -->
				<form action="RegisterUser" method="post" id="register-account-form">
					@csrf
					<div class="input-with-icon-left">
						<i class="icon-feather-user"></i>
						<input type="text" class="input-text with-border" name="firstname" id="emailaddress-register" placeholder="First Name"  />
						@error('firstname')
							<div>{{$message}}</div>
						@enderror
					</div>
					...
					<div class="input-with-icon-left">
						<i class="icon-feather-user"></i>
						<input type="text" class="input-text with-border" name="lastname" id="emailaddress-register" placeholder="Last Name"  />
						@error('lastname')
							<div>{{$message}}</div>
						@enderror
					</div>
					...
					<div class="input-with-icon-left">
						<i class="icon-feather-user"></i>
						<input type="text" class="input-text with-border" name="username" id="emailaddress-register" placeholder="Username"  />
						@error('username')
							<div>{{$message}}</div>
						@enderror
					</div>
					...
					<div class="input-with-icon-left" title="Should be at least 8 characters long" data-tippy-placement="bottom">
						<i class="icon-material-outline-lock"></i>
						<input type="password" class="input-text with-border" name="password" id="password-register" placeholder="Password"  />
						@error('password')
							<div>{{$message}}</div>
						@enderror
					</div>
