							...
							<div class="row">
								...
								<div class="col">
									<div class="row">
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<h5>Add at most five subject you are very good with <i class="help-icon" data-tippy-placement="right" title="Add at most 5 skills"></i></h5>
										...
										<div class="submit-field">
											...
											<div class="account-type">
												<div>
													...
													<label for="freelancer-radio" class="ripple-effect-dark"><i class="icon-material-outline-account-circle"></i>Individual classes</label>
												</div>

												<div>
													<input type="radio" name="account-type-radio" id="employer-radio" class="account-type-radio"/>
													<label for="employer-radio" class="ripple-effect-dark"><i class="icon-material-outline-group"></i> Group classes</label>
												</div>
												<div>
													<input type="radio" name="account-type-radio" id="Both classes" class="account-type-radio"/>
													<label for="Both classes" class="ripple-effect-dark"><i class="icon-material-outline-business-center"></i> Both classes</label>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-12">
										<div class="submit-field">
											...
											<select class="selectpicker with-border" >
												<option value="I can receive student in my home">I can receive student in my home</option>
												<option value="I can give student online class">I can give student online class</option>
												<option value="I can travel to the student home">I can travel to the student home</option>
											</select>
										</div>
									</div>
									<div class="col-xl-12">
